...
const Chatbot = () => {
  ...
  const RenderChatWindow = () => {
    ...
    return (
      ...
      {/* Chatbot window */}
      <h1>Ask</h1>
      <p>Ask a question related to your culinary needs</p>
  ...
  const RenderDocWindow = () => {
    ...
    <h1>Review</h1>
    <p>Review the relevant source documentation</p>
  ...
  const RenderFileWindow = () => {
    ...
    <h1>Revisit</h1>
    <p>Visit the documents you previously viewed</p>
